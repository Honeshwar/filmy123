      ...
      <div className="container mx-auto px-4 py-8">
        ...
        {/* <div className="prose prose-invert max-w-none">
          <p className="text-lg text-white/80 mb-6">
            By accessing or using the Filmy123 website or services, you agree to
          ...
          <p className="text-white/80 mb-6">
            By using Filmy123, you agree to be bound by these Terms. If you do
            not agree with any part of these Terms, please do not use the
            Service.
          </p>

          <h2 className="text-2xl font-bold text-white mt-8 mb-4">
            2. Disclaimer – No Hosted Content
          </h2>
          <p className="text-white/80 mb-6">
            Filmy123 does not host or store any videos or media files on its
            servers. All content available through this website is sourced via
            publicly available open-source and third-party links already
            accessible on the internet. We are not affiliated with any of the
            external sites linked to on our platform.
          </p>
          ...
          <p className="text-white/80 mb-6">
            We value your privacy. Please read our Privacy Policy to understand
          ...
          <p className="text-white/80 mb-6">
            You agree not to use this website for any unlawful purposes. You may
            not:
          </p>
          <ul className="list-disc list-inside text-white/80 space-y-2 mb-6">
            <li>Violate any applicable laws or regulations.</li>
            <li>Attempt to hack, disrupt, or overload the site or servers.</li>
            <li>Use the site’s data for commercial gain without permission.</li>
          ...
          <p className="text-white/80 mb-6">
            Filmy123 does not claim ownership of any media content linked on
            this platform. All trademarks and copyrights belong to their
            respective owners.
          </p>
          ...
          <p className="text-white/80 mb-6">
            We reserve the right to block or remove user access at any time,
          ...
          <p className="text-white/80 mb-6">
            All content is provided "as-is" and we do not guarantee the
            accuracy, quality, or legality of any external link or material.
          </p>
          ...
          <p className="text-white/80 mb-6">
            Filmy123 is not responsible for any damages or losses arising from
            the use of content or links provided on the platform.
          </p>

           <h2 className="text-2xl font-bold text-white mt-8 mb-4">10. Governing Law</h2>
            <p className="text-white/80 mb-6">
            These Terms are governed by applicable laws in the jurisdiction where the site operates.
            </p> 

          <p className="text-white/80 mt-12">Last updated: April 17, 2025</p>
        </div> */}
      </div>
    </main>
  );
